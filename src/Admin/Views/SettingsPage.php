<div class="wrap">
    ...
    <h3><?php esc_html_e('Le plugin est aussi utilisable via un shortcode, copiez ce code sur la page de confirmation de commande que vous avez choisis: [custom_thank_you_page]', 'audio-carousel'); ?></h3>
